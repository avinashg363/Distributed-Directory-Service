...
def updateFunction(final_values,deleted_var):
	...
	for var in deleted_var:
		...
		if not cur.execute(query) == 0:
			...
			print 'not deleted'
	print 'inside update, final value :::'
	print
	print
	print
	print
...
ips= ['10.145.176.203','127.0.0.1','10.145.186.255']
...
while 1:
	...
	if success == 1:
		...
		if failure == 0:
			...
			open('logfile1.txt',"w").close()
			open('initial_table_1.txt',"w").close()
