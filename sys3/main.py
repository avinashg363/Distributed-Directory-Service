...
root.parent = None
root.tablename = None
root.classname = 'InstitutionalBody'
...
li = []
li.append(2)
replicated_root.name = 'KGPCAMPUS'
replicated_root.parent = None
replicated_root.tablename = None
replicated_root.classname = 'campus'
replicated_dic[2] = replicated_root
replicated_invdic[replicated_root] = 2
